...
class Custom_Constants {
	 ...
	 */
		...
		const admin_blogs_listing_url = "blogs";
		const new_blogs_url = "blogs/newblog";
		const edit_blogs_url = "blogs/editblog";
		const admin_blogs_view = "blogs/adminview";
		
		/*event category up related constants*/
		const admin_events_category_listing_url = "events/eventcategories";
		const new_events_category_url = "events/neweventscategory";
		const edit_events_category_url = "events/editeventscategory";
		const admin_events_category_view = "events/readeventcategory";
		

		/* events related constants*/
		const admin_events_listing_url = "events";
		const new_events_url = "events/newevent";
		const edit_events_url = "events/editevent";
		const admin_events_view = "events/adminview";
		...
		const admin_car_listing_url = "cars/adminindex";
		const new_car_url = "cars/newcar";
		const edit_car_url = "cars/editcar";
		const admin_car_view = "cars/adminview";
		const upload_car_csv_file = "cars/uploadcarscsvfile";
		const upload_car_model_csv_file = "cars/uploadcarmodelscsvfile";
		const upload_car_model_variation_csv_file = "cars/uploadcarmodelvariationscsvfile";
		const upload_car_specification_csv_file = "cars/uploadcarspecificationcsvfile";
		const upload_used_car_csv_file = "cars/uploadusedcarcsvfile";
		const upload_car_model_feature_file = "cars/uploadcarmodelfeature";
		
		const view_used_car_url = 'cars/adminusedcarindex';
		const new_used_car_url = 'cars/newusedcar';
		const edit_used_car_url = 'cars/editusedcar';


		/*car categories related Constants*/
		const admin_car_category_listing_url = "cars/adminindexcategory";
		const new_car_category_url = "cars/newcategory";
		const edit_car_category_url = "cars/editcategory";
		const admin_car_category_view = "cars/adminviewcategory";
		...
		/*Vendor with vendor related constants*/
		...
		const admin_vendor_category_listing_url = "vendors/adminindexcategory";
		const new_vendor_category_url = "vendors/newcategory";
		const edit_vendor_category_url = "vendors/editcategory";
...
*/		const student_account = "students/dashboard";
	 ...
	 */
		...
		const main_site_url = "https://www.abhitakk.com";
		const main_site_display = "";
	 ...
	 */
	 //print_r($_SERVER);exit;
		const mailer_host = 'primarykeytech.in';
		const mailer_address = 'noreply@primarykeytech.in';
		const mailer_name = 'Primary Key Technologies';
		const mailer_password = 'pkt@123*#';

...
$input['is_active']  = array(
          "name" => "slider_details[0][is_active]",
                ...
                <div class="box-body">
                  ...
                  <div class="box-body" style="overflow-x:scroll">
                    <table class="table" id="target">
                      ...
                      <tbody>
                        <?php if(count($values_posted['slider_details'])>0){
                         ...
                         //print_r($slider_detail['title_1']);
                          ...
                          <td><input type="text" name="slider_details[<?php echo $key;?>][priority]" id="priority_<?php echo $key;?>" class="form-control" value="<?php echo isset($slider_detail['priority'])?$slider_detail['priority']:'';?>">
                            <?php echo form_error('data[slider_images][priority]');?></td>
                            <td><input type="checkbox" name="slider_details[<?=$key?>][is_active]" id="is_active_<?=$key?>" <?php if($slider_detail['is_active']){echo "checked='checked'";}?> class="form required flat-red"></td>
                          <td></td>
                        </tr>
                          <?php }
                        } else { ?>
                        <tr id="0">
                          ...
                          <td><?php echo form_input($input['priority']);?>
                            <?php echo form_error('data[slider_images][priority]');?></td>
                          <td><?=form_open($input['is_active'])?></td>
                          <td></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                      <tfoot>
                        <tr>
                            <td colspan="9"><button type="button" id="AddMoreSliderImages" class="btn btn-info pull-right AddMoreRow">Add More</button>
                            </td>
                          </tr>
                      </tfoot>
                    </table>

...
$input['about_employee'] = array(
						"name" => "data[employees][about_employee]",
							...
							<div class="box box-info">
								...
								<div class="box-body">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
								                <label for="about_employee"  class="col-sm-1 control-label">About Employee</label>

								                <div class="col-sm-11">
									                
								                  	<!-- <input type="text" class="form-control pull-right" id="datepicker"> -->
								                  	<?php echo form_textarea($input['about_employee']);?>
													<?php echo form_error('data[employees][about_employee]'); ?>
								                </div>
								                <!-- /.input group -->
								            </div>
										</div>

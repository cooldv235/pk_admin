				...
				<table class="table" id="target">
					...
					if(count($product_images)>0){
						...
						<tr id="<?php echo $productImageKey; ?>">
							...
							<td>
								<input type="text" name="product_images[<?php echo $productImageKey;?>][title]" id="title_<?=$productImageKey?>" class="form-control" value="<?=$product_image['title']?>">
							...
							<td>
								<input type="number" name="product_images[<?php echo $productImageKey;?>][priority]" id="priority_<?=$productImageKey?>" value="<?=$product_image['priority']?>" placeholder="Priority *" type="number" class="form-control">
							</td>

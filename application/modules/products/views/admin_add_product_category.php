...
$input['priority'] =  array(
							"name" => "data[product_categories][priority]",
							...
							<div class="box box-info">
								...
								<div class="box-body">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[product_categories][slug]'); ?>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="inputImage_name_1" class="col-sm-2 control-label">Featured Image</label>
												<div class="col-sm-10">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="inputInput_name_2" class="col-sm-2 control-label">Banner Image</label>
												<div class="col-sm-10">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[product_categories][priority]');?>
												</div>
											</div>
										</div>
									</div>

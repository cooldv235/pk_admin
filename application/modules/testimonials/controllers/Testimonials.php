...
class Testimonials extends MY_Controller {
	...
	function setup(){
		$setup = $this->testimonial_model->tbl_company_testimonials();
		return true;
	}
    ...
    $("#testimonial-slider").owlCarousel({
        ...
        $data['css'] = ['<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.css">',
'<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.theme.min.css">', '<link rel="stylesheet" type="text/css" href="'. base_url('assets/css/testimonial.css'). '">'];
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			if(isset($value['name']) && $value['company']) {
				...
				if(!empty($_FILES['company_testimonials']['name'])) {
					$imageFileValidationParams = ['file'=>$_FILES['company_testimonials'], 'path'=>'../content/uploads/testimonials/', 'ext'=>'jpeg|jpg|png|gif', 'fieldname'=>'image', 'arrindex'=>'company_testimonials'];

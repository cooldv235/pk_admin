...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-edit margin-r-5"></i> events</li>
  </ol>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><i class="fa fa-edit margin-r-5"></i> events</h3>
          <?php echo anchor(custom_constants::new_events_url, 'New events', 'class="btn btn-primary pull-right"'); ?>
        </div>
        <!-- /.box-header -->
        <div class="box-body" style="overflow-x: scroll;">
          ...
          <table id="example2" class="table table-bordered table-striped example2">
            ...
            <tbody>
                <?php foreach($events_category as $key=> $v) {
                	//print_r($v);?>
            <tr>
             ...
             <!-- <td><?php echo word_limiter($v['content'], 20);?></td>-->
              ...
              <td><img src="<?php echo content_url().'uploads/events/'.$v['featured_image'];?>" height="100px"></td>
               ...
               <div class="input-group-btn">
                 ...
                 <ul class="dropdown-menu">
                  <!-- <li><?php echo anchor(custom_constants::admin_product_view.'/'.$v['id'], 'View', ['class'=>'']);  ?></li> -->
                   <li><?php echo anchor(custom_constants::edit_events_url."/".$v['id'], 'Edit', ['class'=>'']); ?></li>

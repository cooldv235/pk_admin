...
$input['parent_id'] = array(
						"name" => "data[event_categories][parent_id]",
						"required" => "required",
...
$input['image_name_2'] =  array(
							...
							//"type"	=> "file",
							"id" => "image_name_2",
/*							"value" =>	set_value('event_categories'),
*/							 );
...
$input['is_active'] =  array(
							"name" => "data[event_categories][is_active]",
							"type" => "checkbox",
							"class" => "flat-red",
							"id" => "is_active",
							"value" => true
...
/*if(isset($values_posted['data']['event_categories']['is_active'])){
	$input['is_active'] = "checked='checked'";
	unset($values_posted['data']['event_categories']['is_active']);
}*/
...
<section class="content-header">
	...
	<ol class="breadcrumb">
	    ...
	    <li>
	      <?php echo anchor(custom_constants::admin_events_category_listing_url, 'Event Categories', 'title="Events_Category" id="event_categories"'); ?>
	    </li>
		...
		<div class="col-md-12">
			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
						...
						echo form_open_multipart(custom_constants::new_events_category_url, ['class'=>'form-horizontal', 'id'=>'event_categories']);
							...
							<div class="box box-info">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<?php echo form_dropdown('data[event_categories][parent_id]', $option['parent'], isset($values_posted)?$values_posted['data']['event_categories']['parent_id']:'', $input['parent_id']); ?>
													<?php echo form_error('data[event_categories][parent_id]'); ?>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[event_categories][category_name]'); ?>
												</div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[event_categories][slug]'); ?>
												</div>
											</div>
										</div>
										<div class="col-md-6">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<?php echo form_error('data[event_categories][is_active]');?>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-11">
													<?php echo form_input($input['description']);?>
                  									<?php echo form_error('data[event_categories][description]'); ?>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="box-footer">  
									<button type="submit" class="btn btn-info pull-left">Add Event Category</button> &nbsp;&nbsp;&nbsp;&nbsp;

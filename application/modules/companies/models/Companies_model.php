...
class Companies_Model extends CI_Model {
    ...
    function tbl_companies(){
    	...
    	if(!$check){
            ...
            $query = $this->db->query("CREATE TABLE `company_details` (
  `id` int(11) NOT NULL,

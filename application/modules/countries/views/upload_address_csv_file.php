<section class="content">
  ...
  echo form_open_multipart('countries/upload_address_csv_file'); ?>
    <div class= "row">
      <div class="col-md-6">
        <!-- general form elements -->
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Upload Country/States/City/Area</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <div class="box-body">
              <div class="row">
                ...
                <div class="form-group">   
                  <br>
                  <?php echo nbs(4);?>
                  <input type="file" name='sel_file' style="margin-left: 15px" required accept=".xls, .xlsx">
                </div>

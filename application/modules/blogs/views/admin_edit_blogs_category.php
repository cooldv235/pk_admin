...
$value='';
// /echo $values_posted['blogs_categories']['dob'];exit;
...
$input['gst'] = array(
						"name" => "data[blogs_categories][gst]",
						"placeholder" => "GST *",
						"max_length" => "64",
						"required" => "required",
						"class" => "form-control",
...
$input['image_name_1_2'] =  array(
							"data[blogs_categories][image_name_1_2]" => $values_posted['blogs_categories']['image_name_1'],
							"data[blogs_categories][id]" => $id,
							//"value" =>	$values_posted['blogs_categories']['logo_image'],
							 );
...
$input['image_name_2_2'] =  array(
							"data[blogs_categories][image_name_2_2]" => $values_posted['blogs_categories']['image_name_2'],
							"data[blogs_categories][id]" => $id,
							//"value" =>	$values_posted['blogs_categories']['logo_image'],
							 );
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li>
			<?php echo anchor(custom_constants::admin_blogs_category_listing_url, 'Blogs Categories', 'title="Blogs Categories" id="blogs_categories"'); ?>
		</li>
		...
		<div class="col-md-12">
        	...
        	<div class="nav-tabs-custom">
				...
				<div class="tab-content">
					...
					<?php  
					echo form_open_multipart(custom_constants::edit_blogs_category_url."/".$id, ['class'=>'form-horizontal', 'id'=>'blogs_categories'])
					?>
						<div class="box box-info">
							...
							<div class="box-body">
								<div class ="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<?php 
												echo form_dropdown('data[blogs_categories][parent_id]', $option['parent'], $values_posted['blogs_categories']['parent_id'], 'class="form-control select2" id="parent_id" style="width:100%"');

												//echo form_dropdown('data[blogs_categories][parent_id]', $parents, $values_posted['blogs_categories']['parent_id'], "id='parent_id' class='form-control' required='required'"); ?>
												
													
												 <!--select name="data[blogs_categories][parent_id]" id='parent_id' class="form-control select2">
													<option value="0">Select Parent</option>
													<?php foreach($parents as $parentKey => $parent) {?>
													<option value="<?php echo $parent['id'];?>"<?php if($parent['id']== $values_posted['blogs_categories']['parent_id']/* && $parent['parent_id'] == $values_posted['blogs_categories']['parent_id']*/){ echo "selected='selected'";}?>><?php echo $parent['category_name'];?></option>
													<?php } ?>
												</select-->
											</div>
										</div>
									...
									<div class="col-md-6">
										<div class="form-group">                          
											...
											<div class="col-sm-10">
												...
												<img src="<?php echo content_url().'uploads/'.(!empty($values_posted['blogs_categories']['image_name_1'])?'blogs_categories/'.$values_posted['blogs_categories']['image_name_1']:'no_image.jpg'); ?>" height="80px" width="80px">
									...
									<div class="col-md-6">
										<div class="form-group">                          
											...
											<div class="col-sm-10">
												...
												<img src="<?php echo content_url().'uploads/'.(!empty($values_posted['blogs_categories']['image_name_2'])?'blogs_categories/'.$values_posted['blogs_categories']['image_name_2']:'no_image.jpg'); ?>" height="80px" width="80px">
								...
								<div class="box-footer">  
									<button type="blogs_categories" class="btn btn-info pull-left">Update</button> &nbsp;&nbsp;&nbsp;&nbsp;
									<?php /*echo nbs(3);*/ ?>

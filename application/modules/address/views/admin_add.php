			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<?php echo form_input($input['lat']); ?>
							<?php echo form_error('data[address][lat]'); ?>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<?php echo form_input($input['lng']); ?>
							<?php echo form_error('data[address][lng]'); ?>
						</div>
					</div>
				</div>
			</div>

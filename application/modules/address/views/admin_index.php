            ...
            <div class="box-body" style="overflow-x: scroll;">
              ...
              <table id="example2" class="table table-bordered table-striped example2" style="overflow-x: scroll;">
                ...
                <tr>
                  ...
                  <td>
                      <i class="fa <?php echo (true==$v['is_default'])?'fa-check-circle alert-success':'fa-remove alert-danger';?>"></i> 
                  </td>
                  <td>
                      <i class="fa <?php echo (true==$v['is_active'])?'fa-check-circle alert-success':'fa-remove alert-danger';?>"></i> 
                  </td>
                  <td>
